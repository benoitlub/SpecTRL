      ...
      >
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-1 flex flex-wrap gap-x-3 gap-y-0.5">
            ...
            <Witness label="ENV" value={habitat} color="#9b59ff" />
          </div>
        </div>
        ...
        <div className="relative flex items-center justify-center shrink-0">
          {(isListening || isAnalyzing) && (
            <>
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-14 h-14 rounded-full border border-cyan-400/25 animate-ping" style={{ animationDuration: "1.5s" }} />
              </div>
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-20 h-20 rounded-full border border-purple-400/20 animate-ping" style={{ animationDuration: "2s" }} />
              </div>
            </>
          )}
          ...
          >
            {isAnalyzing ? (
              <svg className="w-6 h-6 text-purple-300 animate-spin" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5}>
              ...
              <div className="w-5 h-5 bg-purple-400 rounded-sm" />
            ) : (
