...
export function OctopusMonitor() {
  ...
  return (
    <div className="fixed bottom-24 right-3 z-40 max-w-[calc(100vw-1.5rem)] font-mono">
      ...
      {open && (
        <div className="mt-2 w-72 rounded-xl border border-cyan-300/25 bg-slate-950/95 p-3 text-[9px] text-cyan-100 shadow-[0_0_28px_rgba(0,212,255,0.14)] backdrop-blur">
